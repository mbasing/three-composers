...
app.controller("ComposerController",function($scope){
    $scope.pieces = [
       ...
       {"pic": "assets/beethoven.png", "composer": "Beethoven", "title": "Symphony #9"},
       {"pic": "assets/beethoven.png", "composer": "Beethoven", "title": "Fur Elise"},
       {"pic": "assets/beethoven.png", "composer": "Beethoven", "title": "Moonlight Sonata"},
       {"pic": "assets/beethoven.png", "composer": "Beethoven", "title": "Violin Concerto"},
       {"pic": "assets/beethoven.png", "composer": "Beethoven", "title": "Egnant Overture"},
